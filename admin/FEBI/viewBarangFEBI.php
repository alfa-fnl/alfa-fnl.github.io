<?php 
    $qb = new lsp();
    $dataB = $qb->select("febi");
    if ($_SESSION['level'] != "Admin") {
    header("location:../index.php");
    }
    if (isset($_GET['delete'])) {
        $response = $qb->delete("febi","kd_barang",$_GET['id'],"?page=viewBarangFEBi");
    }
 ?>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="locations" style="font-family: Times New Roman; color: #9F8953;">Fakultas Ekonomi dan Bisnis Islam</div>

                            <a href="?page=addBarangFEBI" class="btn btn-dark"><img src="gambar/tombol.png"> Tambah Barang</a>
                           </button>
                                        ...
                                        <script>
                                            $('#btdelete<?php echo $no; ?>').click(function(e){
                                                  e.preventDefault();
                                                    ...
                                                    if (isConfirm) {
                                                        window.location.href="?page=viewBarangFEBI&delete&id=<?php echo $ds['kd_barang'] ?>";
                                                    }
                                                  });
                                                });
                                        </script>
